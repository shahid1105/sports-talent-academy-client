      ...
      <div className="max-w-screen-xl p-4 bg-neutral bg-opacity-80 rounded">
        <Carousel
          ...
          <div className="carousel-item">
            ...
            <div className="carousel-caption">
              <p className="text-black md:text-[30px] lg:text-[50px]">
                Get ready for an adrenaline-filled game of basketball! Join us
                as we showcase the best talents from around the world, dribbling
          ...
          <div className="carousel-item">
            ...
            <div className="carousel-caption">
              <p className="text-black md:text-[30px] lg:text-[50px]">
                Buckle up for a thrilling race! Witness the speed and precision
                of the world is top Formula 1 drivers as they compete for the
                championship title on the most iconic tracks.
              </p>
            </div>
          </div>
          <div className="carousel-item">
            ...
            <div className="carousel-caption">
              <p className="text-black md:text-[30px] lg:text-[50px]">
                The football fever is on! Do not miss the action-packed matches,
                as teams clash on the field to claim the ultimate glory in the
                world is most popular sport.
              </p>
            </div>
          </div>
          <div className="carousel-item">
            ...
            <div className="carousel-caption">
              <p className="text-black md:text-[30px] lg:text-[50px]">
                It is time for some intense tennis action! Watch tennis stars
                smash powerful serves and engage in fierce rallies,
          ...
          <div className="carousel-item">
            ...
            <div className="carousel-caption">
              <p className="text-black md:text-[30px] lg:text-[50px]">
                ...
                from diverse nations showcase their talents in various sports,
                inspiring the world with their dedication and perseverance.
              </p>
            </div>
          </div>
          <div className="carousel-item">
            ...
            <div className="carousel-caption">
              <p className="text-black md:text-[30px] lg:text-[50px]">
                L Experience the thrill of the Olympic Games! Witness athletes
                from diverse nations showcase their talents in various sports,
                inspiring the world with their dedication and perseverance.
              </p>
            </div>
